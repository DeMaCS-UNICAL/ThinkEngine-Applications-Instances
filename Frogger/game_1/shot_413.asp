...
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(3,car(posX(-15))))).
...
trunkLine3(trunkSpawnerLine3,objectIndex(16),trunkSpawner(spawnedComponents(1,trunk(posX(6))))).
trunkLine3(trunkSpawnerLine3,objectIndex(16),trunkSpawner(spawnedComponents(0,trunk(posX(16))))).
...
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(2,car(posX(-13))))).
...
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(7,car(posX(9))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(6,car(posX(11))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(5,car(posX(21))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(4,car(posX(23))))).
