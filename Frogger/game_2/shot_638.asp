...
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(1,car(posX(22))))).
...
goal5(goal5,objectIndex(1),goal(empty(false))).
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(3,car(posX(6))))).
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(2,car(posX(-2))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(3,car(posX(-4))))).
...
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(0,car(posX(22))))).
...
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(4,turtle(posX(6))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(3,turtle(posX(2))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(2,turtle(posX(3))))).
...
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(7,car(posX(20))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(6,car(posX(22))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(5,car(posX(32))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(4,car(posX(34))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(1,car(posX(8))))).
lineCars1(lineCars1,objectIndex(9),scrollLine(carComponents(0,car(posX(10))))).
...
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(13,turtle(posX(17))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(12,turtle(posX(18))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(11,turtle(posX(14))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(10,turtle(posX(15))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(9,turtle(posX(11))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(8,turtle(posX(12))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(7,turtle(posX(8))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(6,turtle(posX(9))))).
turtleLine2(tSpawnerLine2,objectIndex(13),turtleSpawner(spawnedComponents(5,turtle(posX(5))))).
...
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(0,car(posX(14))))).
...
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(6,car(posX(0))))).
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(5,car(posX(8))))).
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(4,car(posX(6))))).
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(3,car(posX(16))))).
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(2,car(posX(32))))).
lineCars4(lineCars4,objectIndex(8),scrollLine(carComponents(1,car(posX(24))))).
...
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(6,car(posX(26))))).
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(5,car(posX(32))))).
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(2,car(posX(8))))).
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(1,car(posX(14))))).
...
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(4,car(posX(38))))).
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(3,car(posX(2))))).
lineCars2(lineCars2,objectIndex(7),scrollLine(carComponents(0,car(posX(20))))).
...
playerSensor(player,objectIndex(10),player(posX(18))).
...
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(5,car(posX(-10))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(4,car(posX(6))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(3,car(posX(-2))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(2,car(posX(14))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(1,car(posX(30))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(0,car(posX(22))))).
