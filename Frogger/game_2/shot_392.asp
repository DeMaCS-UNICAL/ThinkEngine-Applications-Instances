...
playerSensor(player,objectIndex(10),player(posZ(6))).
...
playerSensor(player,objectIndex(10),player(posX(8))).
...
trunkLine1(trunkSpawnerLine1,objectIndex(14),trunkSpawner(spawnedComponents(0,trunk(posX(20))))).
