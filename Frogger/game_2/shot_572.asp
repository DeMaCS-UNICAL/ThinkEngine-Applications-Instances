...
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(3,car(posX(2))))).
...
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(2,car(posX(-6))))).
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(1,car(posX(18))))).
lineCars3(lineCars3,objectIndex(11),scrollLine(carComponents(0,car(posX(10))))).
...
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(5,car(posX(-5))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(4,car(posX(11))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(3,car(posX(3))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(2,car(posX(19))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(1,car(posX(35))))).
lineSuperCar(lineSuperCar,objectIndex(6),scrollLine(carComponents(0,car(posX(27))))).
